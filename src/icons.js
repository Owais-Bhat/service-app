// Illustrated Flat 3D Icon Set — bold outlines, flat tinted fills, chunky style.
// Inspired by the "Generic Others" illustrated icon style (thick stroke + flat fill + white highlights).
// Uses currentColor for strokes/outlines so icons adapt to any theme color.
export const ICONS = {
  ...
  staff: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  block: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="12" r="9.5" fill="currentColor" opacity=".18" stroke="none"/>
    <circle cx="12" cy="12" r="9.5"/>
  ...
  rupee: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  card: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  menu: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
  ...
  plus: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.8" stroke-linecap="round">
