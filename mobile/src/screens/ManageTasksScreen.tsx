...
// Tiny press-scale wrapper — the "3D" tactile feel for the action buttons on
// this screen (spring back on release instead of a flat opacity dim).
...
function StatusUpdateModal({ item, onDismiss, onSaved }: { item: TaskItem; onDismiss: () => void; onSaved: () => void }) {
